...
function installToken($root_url, $client_email, $license_code, $pdo = null)
{
    ...
    // Skip license installation on localhost
    if (aplIsLocalhost()) {
        $notifications_array['notification_case'] = "notification_license_ok";
        $notifications_array['notification_text'] = "License installation bypassed for localhost environment";
        return $notifications_array;
    }
...
function verifyToken($pdo, $FORCE_VERIFICATION = 0)
{
    ...
    // Skip license verification on localhost
    if (aplIsLocalhost()) {
        $notifications_array['notification_case'] = "notification_license_ok";
        $notifications_array['notification_text'] = "License check bypassed for localhost environment";
        return $notifications_array;
    }
