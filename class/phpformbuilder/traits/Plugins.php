...
trait Plugins
{
     ...
     * @return \phpformbuilder\Form
     */
    public function addPlugin(string $plugin_name, string $selector, string $js_config = 'default', array $plugin_settings = []): self
    {
     ...
     * @param string $response_fieldname Google recaptcha response fieldname
     * @param string $xml_config The xml configuration of the plugin
     * @return \phpformbuilder\Form
     */
    public function addRecaptchaV3($sitekey, $action = 'default', $response_fieldname = 'g-recaptcha-response', $xml_config = 'default'): self
    {
     ...
     * @return \phpformbuilder\Form
     */
    public function startDependentFields($parent_field, $show_values, $inverse = false): self
    {
