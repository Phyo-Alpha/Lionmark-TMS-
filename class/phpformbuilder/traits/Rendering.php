...
trait Rendering
{
     ...
     *
     */
    public function render(bool $debug = false, bool $display = true)
    {
     ...
     */
    public function printIncludes(string $type, bool $debug = false, bool $display = true)
    {
     ...
     * @return mixed
     */
    public function printJsCode(bool $debug = false, bool $display = true)
    {
        $this->getJsCode();
        if ($debug) {
