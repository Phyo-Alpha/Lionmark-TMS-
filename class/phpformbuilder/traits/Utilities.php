...
trait Utilities
{
     ...
     */
    public function addAddon(string $input_name, string $addon_html, string $pos): self
    {
     ...
     * @return void
     */
    public function addHeading(string $html, string $tag_name = 'h4', string $attr = ''): void
    {
        $heading_attr = '';
        if (!empty($attr)) {
     ...
     * @return \phpformbuilder\Form
     */
    public function addHelper(string $helper_text, string $element_name): self
    {
     ...
     * @return \phpformbuilder\Form
     */
    public function addHtml(string $html, string $element_name = '', string $pos = 'after'): self
    {
     ...
     * @return \phpformbuilder\Form
     */
    public function addIcon(string $input_name, string $icon_html, string $pos): self
    {
     ...
     * @return \phpformbuilder\Form
     */
    public function addInputWrapper(string $html, string $element_name): self
    {
     ...
     * @return \phpformbuilder\Form
     */
    public function groupElements(string $input1, string $input2 = '', string $input3 = '', string $input4 = '', string $input5 = '', string $input6 = '', string $input7 = '', string $input8 = '', string $input9 = '', string $input10 = '', string $input11 = '', string $input12 = ''): self
    {
        $group = [];
     ...
     * @return \phpformbuilder\Form
     */
    public function setCols(int $label_col_number, int $field_col_number, string $breakpoint = 'sm'): self
    {
        $options = [];
     ...
     * @return \phpformbuilder\Form
     */
    public function startCol(int $col_number, string $breakpoint = 'sm', string $additionalClass = '', string $id = ''): self
    {
        $col_clazz = '';
     ...
     * @return \phpformbuilder\Form
     */
    public function startFieldset(string $legend = '', string $fieldset_attr = '', string $legend_attr = ''): self
    {
     ...
     * @return \phpformbuilder\Form
     */
    public function startRow(string $additional_class = '', string $id = ''): self
    {
        $clazz = '';
        $fw_clazz = [
            'bs4'         => 'row',
