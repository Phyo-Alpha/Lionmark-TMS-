...
require_once GENERATOR_DIR . 'class/generator/Generator.php';
session_start();
...
require_once 'inc/default-generator-styles.php';
...
if (!empty($generator->table)) {
    ...
    for ($i = 0; $i < $generator->columns_count; $i++) {
        ...
        } elseif ($generator->columns['value_type'][$i] == 'datetime') {
            $_SESSION['form-select-fields']['rp_special_date_' . $column_name] = $generator->columns['special'][$i];
            $_SESSION['form-select-fields']['rp_special_time_' . $column_name] = $generator->columns['special2'][$i];
        }
    ...
    for ($i = 0; $i < $generator->columns_count; $i++) {
        ...
        if (in_array($column_type, $date)) {
            ...
            if ($column_type == 'char' || $column_type == 'varchar' || $column_type == 'tinytext' || $column_type == 'text' || $column_type == 'mediumtext' || $column_type == 'longtext') {
                ...
                $form_select_fields->addHelper(CREATE_IMAGE_THUMBNAILS_HELP, 'rp_special_image_thumbnails_' . $column_name);
...
// canonical URL, page title & desc for PHPCG website
$canonical_url = 'https://www.phpcrudgenerator.com/crud-generator-demo?lang=' . LANG;

$page_title = GENERATOR_PAGE_TITLE;
$page_desc = GENERATOR_PAGE_DESC;
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="alternate" hreflang="cs" href="https://www.phpcrudgenerator.com/crud-generator-demo?lang=cs">
    <link rel="alternate" hreflang="de" href="https://www.phpcrudgenerator.com/crud-generator-demo?lang=de">
    <link rel="alternate" hreflang="en" href="https://www.phpcrudgenerator.com/crud-generator-demo?lang=en">
    <link rel="alternate" hreflang="es" href="https://www.phpcrudgenerator.com/crud-generator-demo?lang=es">
    <link rel="alternate" hreflang="fr" href="https://www.phpcrudgenerator.com/crud-generator-demo?lang=fr">
    <link rel="alternate" hreflang="it" href="https://www.phpcrudgenerator.com/crud-generator-demo?lang=it">
    <link rel="alternate" hreflang="pt-BR" href="https://www.phpcrudgenerator.com/crud-generator-demo?lang=pt-br">
...
<body>
    ...
    <header class="align-items-center d-flex justify-content-between p-3 text-bg-secondary-800">
        ...
        <p class="mb-0 opacity-50"><?php require_once 'update/index.php'; ?></p>
    </header>
    ...
    if (DEMO) {
        ?>
        <div class="container">
            <p class="d-md-flex justify-content-end mt-1 pb-3">
                <button class="btn btn-outline-secondary me-2" title="<?php echo SWITCH_TO_THE_CRUD_GENERATOR; ?>" disabled><i class="<?php echo ICON_ARROW_LEFT; ?> prepend"></i><?php echo SWITCH_TO_THE_CRUD_GENERATOR; ?></button>
                <a href="/admin/home?lang=<?php echo LANG; ?>" class="btn btn-warning mb-2 mb-md-0" title="<?php echo SWITCH_TO_THE_ADMIN_DASHBOARD; ?>"><?php echo SWITCH_TO_THE_ADMIN_DASHBOARD; ?><i class="<?php echo ICON_ARROW_RIGHT; ?> append"></i></a>
            </p>
        </div>
        <?php
    }
    ...
    if (empty($generator->table)) {
        ...
        <div class="container">
            <div class="alert alert-info has-icon">
                <p class="mb-0"><?php echo DATABASE_HAS_NO_TABLE; ?></p>
            </div>
        </div>
        <?php
    }
    ...
    <div class="container tab-content">
        ...
        <div class="tab-pane<?php echo $pill_crud_active; ?>" id="pills-crud" role="tabpanel" aria-labelledby="pills-crud-tab" tabindex="0">
            ...
            if (DEMO) {
                ...
                <div class="container">
                    <div class="row justify-content-md-center">
                        <div class="col-md-10">
                            <div class="alert alert-info alert-dismissible has-icon shadow-sm">
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                <?php echo WEBSITE_GENERATOR_INFO_ALERT_CONTENT; ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            if (DEMO === true) {
                ?>
                <div class="alert alert-info has-icon">
                    <p class="mb-0"><?php echo WEBSITE_CRUD_DISABLED_IN_DEMO; ?></p>
                </div>
                <?php
            }
    ...
    <div id="ajax-modal" class="modal d-none" tabindex="-1">
    ...
    <script type="module" src="<?php echo GENERATOR_URL; ?>generator-assets/javascripts/generator.min.js"></script>
    <?php
    if (isset($form_select_table)) {
