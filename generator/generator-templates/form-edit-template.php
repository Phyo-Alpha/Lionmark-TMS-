...
?>
    $<?php echo $column_name; ?>_ts = null;
    if (!is_null($row-><?php echo $column_name; ?>)) {
        $<?php echo $column_name; ?>_ts = strtotime($row-><?php echo $column_name; ?>);
    }
    // if timestamp is valid and > '1970-01-01'
    if (!is_null($<?php echo $column_name; ?>_ts) && Utils::isValidTimeStamp($<?php echo $column_name; ?>_ts) && $<?php echo $column_name; ?>_ts > -62169984000) {
...
?>
    $values = Utils::decodeJson($row-><?php echo $column_name; ?>);
    $_SESSION['<?php echo $form_id; ?>']['<?php echo $column_name; ?>'] = array();
    if (is_array($values)) {
        foreach ($values as $value) {
            $_SESSION['<?php echo $form_id; ?>']['<?php echo $column_name; ?>'][] = $value;
...
<?php
        ...
        if (!empty($help_text)) {
?>
$form->addHelper('<?php echo str_replace('\'', '\\\'', $help_text); ?>', '<?php echo $name; ?>', 'after');
<?php
        }
