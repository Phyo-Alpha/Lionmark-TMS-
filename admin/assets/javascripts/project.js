...
loadjs.ready('core', function () {
    // material-pickers-base has to be loaded for modals (bulk delete and view record in READ lists)
    loadjs([
        classUrl + 'phpformbuilder/plugins/material-pickers-base/dist/css/material-pickers-base.min.css',
        classUrl + 'phpformbuilder/plugins/material-pickers-base/dist/js/material-pickers-base.js'
    ]);
