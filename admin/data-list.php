...
$table     = $element->table;
$desc      = ucfirst($table) . ' ' . LIST_CONSTANT;
if (DEMO) {
    $desc .= ' - ' . ADMIN_LIST_PAGE_DESC_DEMO;
}
...
<head>
    <title><?php echo SITENAME . ' ' . ADMIN_DASHBOARD . ' - ' . ucfirst($item) . ' ' . LIST_CONSTANT . ' - ' . GENERATOR_PAGE_TITLE; ?></title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <?php echo $meta_robots; ?>
    <link rel="canonical" href="<?php echo  $canonical; ?>">
    <meta name="description" content="PHP CRUD Admin Panel - <?php echo $desc; ?>">
