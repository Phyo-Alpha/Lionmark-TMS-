...
class PhpcgUsersProfiles extends Elements
{
    ...
    public $r_category = array();
    public $u_category = array();
    public $cd_category = array();
    public $cq_category = array();
    public $r_courses = array();
    public $u_courses = array();
    public $cd_courses = array();
    public $cq_courses = array();
    public $r_learners = array();
    public $u_learners = array();
    public $cd_learners = array();
    public $cq_learners = array();
    public $r_trainers = array();
    public $u_trainers = array();
    public $cd_trainers = array();
    public $cq_trainers = array();
    public $r_users = array();
    public $u_users = array();
    public $cd_users = array();
    public $cq_users = array();
    ...
    public function __construct($element, $params = array())
    {
        ...
        $columns = 'phpcg_users_profiles.id, phpcg_users_profiles.profile_name, phpcg_users_profiles.r_category, phpcg_users_profiles.u_category, phpcg_users_profiles.cd_category, phpcg_users_profiles.cq_category, phpcg_users_profiles.r_courses, phpcg_users_profiles.u_courses, phpcg_users_profiles.cd_courses, phpcg_users_profiles.cq_courses, phpcg_users_profiles.r_learners, phpcg_users_profiles.u_learners, phpcg_users_profiles.cd_learners, phpcg_users_profiles.cq_learners, phpcg_users_profiles.r_trainers, phpcg_users_profiles.u_trainers, phpcg_users_profiles.cd_trainers, phpcg_users_profiles.cq_trainers, phpcg_users_profiles.r_users, phpcg_users_profiles.u_users, phpcg_users_profiles.cd_users, phpcg_users_profiles.cq_users, phpcg_users_profiles.r_phpcg_users, phpcg_users_profiles.u_phpcg_users, phpcg_users_profiles.cd_phpcg_users, phpcg_users_profiles.cq_phpcg_users, phpcg_users_profiles.r_phpcg_users_profiles, phpcg_users_profiles.u_phpcg_users_profiles, phpcg_users_profiles.cd_phpcg_users_profiles, phpcg_users_profiles.cq_phpcg_users_profiles';
        $where = array();
        ...
        if (!empty($this->records_count)) {
            while ($row = $db->fetch()) {
                ...
                $this->r_category[] = ElementsUtilities::getUserProfileValue($row->r_category);
                $this->u_category[] = ElementsUtilities::getUserProfileValue($row->u_category);
                $this->cd_category[] = ElementsUtilities::getUserProfileValue($row->cd_category);
                $this->cq_category[] = ElementsUtilities::getUserProfileValue($row->cq_category);
                $this->r_courses[] = ElementsUtilities::getUserProfileValue($row->r_courses);
                $this->u_courses[] = ElementsUtilities::getUserProfileValue($row->u_courses);
                $this->cd_courses[] = ElementsUtilities::getUserProfileValue($row->cd_courses);
                $this->cq_courses[] = ElementsUtilities::getUserProfileValue($row->cq_courses);
                $this->r_learners[] = ElementsUtilities::getUserProfileValue($row->r_learners);
                $this->u_learners[] = ElementsUtilities::getUserProfileValue($row->u_learners);
                $this->cd_learners[] = ElementsUtilities::getUserProfileValue($row->cd_learners);
                $this->cq_learners[] = ElementsUtilities::getUserProfileValue($row->cq_learners);
                $this->r_trainers[] = ElementsUtilities::getUserProfileValue($row->r_trainers);
                $this->u_trainers[] = ElementsUtilities::getUserProfileValue($row->u_trainers);
                $this->cd_trainers[] = ElementsUtilities::getUserProfileValue($row->cd_trainers);
                $this->cq_trainers[] = ElementsUtilities::getUserProfileValue($row->cq_trainers);
                $this->r_users[] = ElementsUtilities::getUserProfileValue($row->r_users);
                $this->u_users[] = ElementsUtilities::getUserProfileValue($row->u_users);
                $this->cd_users[] = ElementsUtilities::getUserProfileValue($row->cd_users);
                $this->cq_users[] = ElementsUtilities::getUserProfileValue($row->cq_users);
