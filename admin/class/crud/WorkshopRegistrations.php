...
class WorkshopRegistrations extends Elements
{
    ...
    public $englishCompetency = array();
    public $vaccinated = array();
    public $workshop = array();
    public $classStartDate = array();
    public $salesperson = array();
    public $hearAboutUs = array();
    public $registrationDate = array();
    public $status = array();
    public $notes = array();
    ...
    public function __construct($element, $params = array())
    {
        ...
        $columns = 'workshop_registrations.id, workshop_registrations.firstName, workshop_registrations.lastName, workshop_registrations.email, workshop_registrations.countryCode, workshop_registrations.phone, workshop_registrations.dob, workshop_registrations.nationality, workshop_registrations.address, workshop_registrations.qualification, workshop_registrations.englishCompetency, workshop_registrations.vaccinated, workshop_registrations.workshop, workshop_registrations.classStartDate, workshop_registrations.salesperson, workshop_registrations.hearAboutUs, workshop_registrations.registrationDate, workshop_registrations.status, workshop_registrations.notes';
        $where = array();
        ...
        $this->main_pdo_settings = array(
            'function' => 'select',
            'from'    => 'workshop_registrations' . $active_filters_join_queries,
            'values'   => $columns,
            'where'    => $where,
        ...
        if (!empty($this->records_count)) {
            while ($row = $db->fetch()) {
                ...
                $this->englishCompetency[] = $row->englishCompetency;
                $this->vaccinated[] = $row->vaccinated;
                $this->workshop[] = $row->workshop;
                $this->classStartDate[] = $row->classStartDate;
