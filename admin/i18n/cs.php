...
define('DATABASE_HAS_NO_TABLE', 'Vaše databáze nemá žádné tabulky. Vytvořte prosím nějaké tabulky, abyste mohli vygenerovat svůj administrátorský panel databáze');
...
define('DELETE_CACHE_AND_REFRESH', 'Klikněte pro odstranění mezipaměti a obnovení');
...
define('LAST_NAME', 'Jméno');
define('LIST_CONSTANT', 'Seznam');
...
define('PHP_ERRORS_MONITOR_ENABLED_HELPER', 'Aktivujte tak, aby obdržel e -mail, když dojde k chybě PHP.');
define('PHP_ERRORS_MONITOR_ENABLED_TXT', 'Povolit sledování chyb PHP');
define('PHP_ERRORS_MONITOR_RECIPIENT_EMAILS_HELPER', 'Uveďte e -mailovou adresu nebo více adres oddělených čárkami');
define('PHP_ERRORS_MONITORING_TXT', 'Monitorování chyb PHP');
define('PRINT', 'Tisk');
...
define('GENERATOR_PAGE_TITLE', 'PHP CRUD - Generátor administrátorských panelů');
define('GENERATOR_PAGE_DESC', 'Tento generátor CRUD se připojí k databázi a analyzuje tabulky, pole a relační strukturu. Umožňuje vygenerovat na několik kliknutí kompletní a profesionální panel správce.');

define('ADMIN_HOME_PAGE_SUBTITLE', 'Ovládací panel správce - Domovská stránka');
define('ADMIN_HOME_PAGE_DESC', 'Ovládací panel správce');
define('ADMIN_HOME_PAGE_SUBTITLE_DEMO', 'Ukázka databáze Sakila');
define('ADMIN_HOME_PAGE_DESC_DEMO', 'Bootstrap admin dashboard s CRUD funkcemi. Tento panel je vytvořen s databází MySQL Sakila pro demonstrační účely.');
define('ADMIN_LIST_PAGE_DESC_DEMO', 'Tento panel správce Bootstrap 5 byl vytvořen z ukázkové databáze Sakila pomocí PHP CRUD GENERATOR.');
...
define('CREATE_IMAGE_THUMBNAILS_HELP', 'Pokud povolíte generování miniatur, musíte v adresáři pro nahrávání vytvořit složku s názvem "thumbs" a pak 3 složky uvnitř adresáře "thumbs" s názvy "lg", "md", "sm".');
