...
define('DATABASE_HAS_NO_TABLE', 'Your database has no tables. Please create some tables to generate your database admin panel');
...
define('DELETE_CACHE_AND_REFRESH', 'Click to delete cache and refresh');
...
define('PHONE', 'Phone');
define('PHP_ERRORS_MONITOR_ENABLED_HELPER', 'Activate to receive an email when a php error occurs.');
define('PHP_ERRORS_MONITOR_ENABLED_TXT', 'Enable PHP ERRORS monitoring');
define('PHP_ERRORS_MONITOR_RECIPIENT_EMAILS_HELPER', 'Indicate an email address, or more addresses separated by commas');
define('PHP_ERRORS_MONITORING_TXT', 'PHP Errors Monitoring');
define('PRINT', 'Print');
...
define('GENERATOR_PAGE_DESC', 'This CRUD Generator connects to your database and analyses the tables, fields, and relational structure. It allows you to generate in a few clicks a complete and professional admin dashboard');

define('ADMIN_HOME_PAGE_SUBTITLE', 'Admin Dashboard - Home');
define('ADMIN_HOME_PAGE_DESC', 'Admin Dashboard');
define('ADMIN_HOME_PAGE_SUBTITLE_DEMO', 'Sakila Database Demo');
define('ADMIN_HOME_PAGE_DESC_DEMO', 'Bootstrap admin dashboard with CRUD functionnalities. This admin panel is built with the MySQL Sakila Database for demo purposes');
define('ADMIN_LIST_PAGE_DESC_DEMO', 'This Bootstrap 5 admin dashboard has been built from the Sakila demo database using PHP CRUD GENERATOR.');
