...
function registerDbInfo()
{
    ...
    if (!file_put_contents(CLASS_DIR . 'phpformbuilder/database/db-connect.php', $db_connect_content)) {
        ...
        if (!$db->isConnected()) {
            $error_msg = 'Unable to connect to the database (' . $db->error() . '<br>Please check your connection settings<br><hr>';
            ...
            // Register license on the licensing server
            ...
            if (empty($error_msg)) {
                $token_notifications_array = installToken(BASE_URL . 'class/phpformbuilder', $_POST['user-email'], trim($_POST['user-purchase-code']), $db->getPdo());
        ...
        if ($already_registered) {
            ...
            if ($current_step == 2) {
                ...
                if ($db_info) {
                    ...
                    $form->addHelper('<a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code" target="_blank" rel="noopener noreferer" title="Where is my Purchase Code?">Where is my Purchase Code?</a>', 'user-purchase-code');
...
<body>
    <header class="align-items-center d-flex justify-content-between p-3 mb-5 text-bg-secondary-800">
        <h1 class="h5 text-start mb-0 opacity-50"><i class="fas fa-wrench fa-lg me-3"></i>PHP CRUD Generator installer</h1>
    </header>
    <div class="container">
        ...
        <div class="row bs-wizard mb-4">
            ...
            <div class="col-3 bs-wizard-step <?php echo $class_step[1]; ?>">
                ...
                <a href="#" class="bs-wizard-dot" aria-label="Step"></a>
            ...
            <div class="col-md-11 col-lg-10 mb-4">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-5"><a href="" aria-label="Step"></a></p>
